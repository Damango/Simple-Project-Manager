...
const ProjectTasks = (props) => {
    ...
    return (<div className="project-tasks-container" >
        ...
        <div className="project-tasks-wrapper">
            ...
            <div className="task-column project-todo"><div className="task-types-title">To Do</div>{props.todos.reverse().map((task) => <Task deleteTask={props.deleteTask} openTask={props.openTaskView} data={task} projectID={props.projectID} />)}</div>
